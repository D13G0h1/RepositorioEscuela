...
import org.alandoc.model.figura.Figura;
...
public class Menu
{
    ...
    public static void leeApotema(){System.out.println( "Dame un apotema" );}

    public static void leeRadio(){System.out.println( "Dame un radio" );}
